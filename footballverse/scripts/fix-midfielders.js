...
const file = 'app/select/midfielders/data.js';
...
async function main() {
    console.log('Checking domains for midfielders...');
    const checks = [];
    ...
    for (let i = 0; i < checks.length; i++) {
        ...
        // No explicit delay here to speed it up. The timeouts will catch hangs.
    }
